...
})({"24pvN":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "de025c6653256dbe";
"use strict";
...
},{}],"ibPvy":[function(require,module,exports) {
// Imports
...
function createYukaCar({ maxSpeed, minSpeed, team, startPos }) {
    ...
    path.add(new _yuka.Vector3(-80, -4, -135));
    path.add(new _yuka.Vector3(-65, -2, -145));
    path.add(new _yuka.Vector3(-55, 1, -170));
    path.add(new _yuka.Vector3(-45, 4, -197));
    ...
    const markerGeometry = new _three.SphereGeometry(0.5, 16, 16);
    const markerMaterial = new _three.MeshBasicMaterial({
        color: 0xff0000
    });
    for (const point of path._waypoints){
        const marker = new _three.Mesh(markerGeometry, markerMaterial);
...
},{"three":"ktPTu","yuka":"ead4k","three/examples/jsm/loaders/GLTFLoader":"dVRsF","three/examples/jsm/controls/OrbitControls":"7mqRv"}]},["24pvN","ibPvy"], "ibPvy", "parcelRequire94c2")

//# sourceMappingURL=qualifying.53256dbe.js.map
